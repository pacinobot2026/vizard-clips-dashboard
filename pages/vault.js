          ...
          <div className="p-8">
            ...
            <div className="grid grid-cols-5 gap-4 mb-8">
              ...
              <div className="bg-gray-900 border border-gray-800 rounded-lg p-4">
                ...
                <div className="text-sm text-gray-400">Sales Pages</div>
              </div>
              <div className="bg-gray-900 border border-gray-800 rounded-lg p-4">
            ...
            <div className="mb-6 space-y-4">
              <div className="flex items-center gap-4">
                <input
                  ...
                  className="flex-1 px-4 py-2 bg-gray-900 border border-gray-800 rounded-lg text-white focus:outline-none focus:border-yellow-500"
                />
              </div>
              ...
              {filteredItems.map(item => (
                ...
                >
                  ...
                  <div className="p-4">
                    ...
                    {item.notes && (
                      <p className="text-xs text-gray-500 line-clamp-2 mb-2">{item.notes}</p>
                    )}
                    {item.tags && item.tags.length > 0 && (
                      <div className="flex flex-wrap gap-1">
                        {item.tags.map((tag, idx) => (
                          <span key={idx} className="text-xs px-2 py-0.5 bg-yellow-900 text-yellow-300 rounded">
                            {tag}
                          </span>
                        ))}
                      </div>
            ...
            {filteredItems.length === 0 && (
              <div className="text-center py-12">
                <p className="text-gray-500 text-lg">No resources found. Add your first one!</p>
              </div>
            )}
          </div>
        </div>
          ...
          <div className="bg-gray-900 border border-gray-800 rounded-lg p-8 max-w-2xl w-full">
            ...
            <form onSubmit={handleUpload} className="space-y-4">
              ...
              <div className="flex gap-4 pt-4">
                <button
                  type="submit"
                  className="flex-1 px-6 py-3 bg-yellow-500 text-gray-900 font-semibold rounded-lg hover:bg-yellow-400 transition"
                >
                  Add Resource
                </button>
                <button
                  ...
                  className="px-6 py-3 bg-gray-800 text-gray-300 font-semibold rounded-lg hover:bg-gray-700 transition"
                >
                  Cancel
                </button>
              </div>
