...
// Loads real clips from initial data, then maintains in memory

// Initial real clips data (from Vizard API)
let clipsCache = [
  {
    "clip_id": "36882833",
...
export function getCategories() {
  const cats = [...new Set(clipsCache.map(c => c.category).filter(Boolean))];
